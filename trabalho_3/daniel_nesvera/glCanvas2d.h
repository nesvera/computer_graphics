...
public slots:
    ...
    void virabrequimCheckBoxChanged(bool enabled);
    void blocoCheckBoxChanged(bool enabled);
    void camisaCheckBoxChanged(bool enabled);
    void pistaoCheckBoxChanged(bool enabled);
    void bielaCheckBoxChanged(bool enabled);
    void rpmSpinBoxChanged(double value);
